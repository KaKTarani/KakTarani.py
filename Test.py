...
import requests,bs4,json,sys,random,datetime,time,re,subKakTarani cess,platform,uuid
...
\x1b[1;97m SnapChat : https://www.snapchat.com/add/korshtarani?share_id=PQmcj5918jk&locale=en-GB

\x1b[1;97m Group : KakTarani 

\x1b[1;97m--------------------------------------------------

\x1b[1;97m This is the campus of Islamic KakTarani  - Fuck Dark Cyber
...
def random_number():
	...
	print('[✓] Crack KakTarani cess has been completed')
...
def rcrack(uid,pwx,tl):
	...
	try:
		...
		for ps in pwx:
			...
			KakTarani  = random.choice(agents)
