...
⬜⬜⬜⬛⬛⬛⬛⬛⬜⬜⬜
      ₊‧.°.⋆☠️•˚₊‧⋆.
        ...
        ᴜᴇsʀ ᴛᴇʟᴇɢʀᴀᴍ:@KakTarani
        ᴠᴇʀsɪᴏɴ ᴛᴏᴏʟ 0.3
        ғᴏʀ 5$ ʟ
        ʙʏ ᴛᴏᴏʟ: KakTarani
        
                 ''',width=79,title=f'[bold green]Tools Bay KakTarani',style='bold hot_pink2'))
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu(my_name,my_id):
	...
	table.add_row("01","𝐶𝑅𝐴𝐶𝐾 𝑃𝑈𝐵𝐿𝐼𝐾","ONLINE")
	table.add_row("02","ᴄʀᴀᴄᴋ ᴍᴀssᴀʟ","ONLINE")
	table.add_row("03","ᴄʀᴀᴄᴋ ғɪʟᴇ","ONLINE")
	table.add_row("04","𝑐𝑒𝑘 𝑟𝑒𝑠𝑢𝑙𝑡","ONLINE")
	table.add_row("05", "Tᴇʟᴇɢʀᴀᴍ ᴜᴇsᴀʀ","ONLINE")
	table.add_row("06","ᴄʜᴀɴɴᴇʟ ᴛᴇʟᴇɢʀᴀᴍ"," ", "ONLINE")
	table.add_row("00", "hatn drwa", "ONLINE")
	Consol=Console()
...
def result():
	...
	if kz in ['2','02']:
		try:vin = os.listdir('𝑪𝒑_KakTarani❌')
		...
		try:vin = os.listdir('𝒐𝒌_KakTarani✅')
		except FileNotFoundError:
			print(' ╰─  File Tidak Di Temukan ')
			time.sleep(4)
			back()
...
def setting():
	...
	table.add_column("STATUS",justify="center",width=20,style="green")
	table.add_row("01","xot korak Assisi zan","VERY RECOMENDED")
	table.add_row("02","asycn mbasic","VERY RECOMENDED")
...
def passwrd():
	...
	print(f'  [{h}•{x}]{h} Oᴋ_KakTarani✅ : {h}%s '%(ok))
	print(f'{x}  [{h}•{x}]{k} Cᴘ_KakTarani❌ : {k}%s{x} '%(cp))
