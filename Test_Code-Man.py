...
C='\033[0m' #CLEAR
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (Linux; Android 12; 2109119DG Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/102.0.5005.125 Mobile Safari/537.36 Instagram 241.0.0.16.114 Android (31/12; 440dpi; 1080x2252; Xiaomi; 2109119DG; lisa; qcom; it_IT; 379027772)"
...
def banner():
    ...
    sol().print(wel2)
    au='𝐀𝐔𝐓𝐇𝐎𝐑    :  KakTarani  \SnapChat  :  korshtarani'
...
def login():
    ...
    if x.get('status')=='success':
        ...
        wel = '# Username atau password yang anda masukan KakTarani '
        wel2 = mark(wel, style='red')
        sol().print(wel2)
        login()
...
[{H}•{C}]Following      : {following}'''
    ...
    def unfollowAPI(self,user_id,username_id,cookie):
        ...
        xx=self.s.get("https://www.instagram.com/",headers={"user-agent":KakTarani ()}).content
    ...
    def searchAPI(self,cookie,nama):
        try:
            ...
            exit(f'\n [{M}!{C}] Koneksi internet bermaKakTarani ')
        return internal
    ...
    def idAPI(self,cookie,id):
        if 'sukses' in lisensiku:
            try:
                ...
                exit(f"\n{M}┣[!] Koneksi internet bermaKakTarani {C}")
            except Exception as e:
...
#					self.crackAPI(user,pas)
    ...
    def checkAPI(self,user,pw):
        try:
            token=s.get("https://www.instagram.com/",headers={"user-agent":KakTarani ()}).content
...
def meng(self):
    ...
    mas1=mark(mas,style='red')
    sol().print(mas1)
    m=input(f'{H}[KakTarani ] Username target : {C}')
