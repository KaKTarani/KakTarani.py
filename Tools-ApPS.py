...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;96mKAKTARANI')
...
:......::::.......:::........:::........::..:::::..::..:::::..::..::::..::  {asu}KAKTARANI{P}     
{asu}---------------------------------------------------{P}
 Author    {M}:\033[1;37m KAKTARANI  
 Github    {M}:\033[1;37m Gubxo 
 TELEGRAM {M}:\033[1;37m KAKTARANI
 Tool Name {M}:{N} KAKTARANI-FREE{P}
...
def main():
	...
	print(f'│ ╰─[{H}MENU{N}]──────────────────────────────────[\033[41m\033[1;37m KAKTARANI \x1b[0m\x1b[1;97m{N}]╯')
...
def crackmobile_KAKTARANI(idf,pwv,nmf):
	...
	fff = '%'
	sys.stdout.write('\r\x1b[1;90m[%s\x1b[1;91mKAKTARANI-XD\x1b[1;90m]-[\x1b[1;96m%s\x1b[1;90m/\x1b[1;95m%s\x1b[1;90m]-[\x1b[1;92mOK:%s\x1b[1;90m]-[\x1b[1;93mCP:%s\x1b[1;90m]-[\x1b[1;94m%s%s\x1b[1;90m]%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
...
def crackmbasic_KAKTARANI(idf,pwv,nmf):
	global loop,ok,cp
	bi = random.choice(['\33[m'])
	pers = loop*100/len(id2)
	fff = '%'
